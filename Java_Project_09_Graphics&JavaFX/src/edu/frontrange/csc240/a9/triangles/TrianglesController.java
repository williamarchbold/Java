 ...
 * @param backGroundColor	the background color selected by the View
 */
public TrianglesController(TrianglesView view, Color backGroundColor)
{
	/* The view for which this is the controller. */
	this.view = view;

	/* Get the model being used by this controller. */
	model = new TrianglesModel(NUMBER_OF_TRIANGLES, backGroundColor);
