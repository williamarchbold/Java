...
public class Assignment6Test_1
{
/**
...
// ------------- Check garbage collection and remaining instances --------------
	...
	if( sectionCount != 1 )
		error("Section count at this point should be 1");
	...
	if( courseCount != 1 ) error("Course count at this point should be 1");
